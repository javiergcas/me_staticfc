...
2) To compute pBOLD on your own data. For this, you can use the standalone program [compute_pBOLD.py](./code/python/compute_pBOLD.py) contained in this repo. Instructions on how to use this program can be found [here](../../wiki/computepBOLD_usage.md)
