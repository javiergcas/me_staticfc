...
USERNAME=`whoami`
SWARM_PATH=`echo /data/SFIMJGC_HCP7T/BCBL2024/swarm.${USERNAME}/S00a_Freesurfer.discovery.SWARM.sh`
LOGS_DIR=`echo /data/SFIMJGC_HCP7T/BCBL2024/logs.${USERNAME}/S00a_Freesurfer.discovery.logs`
...
do
    ...
    echo "3dUnifize -overwrite -prefix ${out_path}/${sbj}_ses-1_T1w.unifize.nii.gz ${sbj_path}/constant_gated/anat/${sbj}_ses-1_T1w.nii.gz; recon-all -all -subject ${sbj} -i ${out_path}/${sbj}_ses-1_T1w.unifize.nii.gz" >> ${SWARM_PATH} 
done
