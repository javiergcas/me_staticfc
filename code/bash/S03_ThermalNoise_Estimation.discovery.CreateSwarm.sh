...
USERNAME=`whoami`
SWARM_PATH=`echo ${PRJDIR}/swarm.${USERNAME}/S03_ThermalNoise_Estimation.discovery.SWARM.sh`
LOGS_DIR=`echo ${PRJDIR}/logs.${USERNAME}/S03_ThermalNoise_Estimation.discovery.logs`
...
do
   ...
   echo "export SBJ=${sbj} DOWNLOAD_DIR=${DOWNLOAD_DIR} DATASET=discovery; sh ${SCRIPTS_DIR}/S03_ThermalNoise_Estimation.sh" >> ${SWARM_PATH}
done
