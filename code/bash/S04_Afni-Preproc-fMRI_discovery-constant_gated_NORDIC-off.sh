...
AFNI_PROC_OUT_DIR=`echo ${SCRIPTS_DIR}/S04_Afni-Preproc-fMRI_discovery-${SES}_NORDIC-off`
USERNAME=`whoami`
SWARM_PATH=`echo ${PRJDIR}/swarm.${USERNAME}/S04_Afni-Preproc-fMRI_discovery-${SES}_NORDIC-off.SWARM.sh`
LOGS_DIR=`echo ${PRJDIR}/logs.${USERNAME}/S04_Afni-Preproc-fMRI_discovery-${SES}_NORDIC-off.logs`
...
do
    ...
    OUT_DIR=`echo ${PRJDIR}/prcs_data/${SBJ}/D03_Preproc_${SES}_NORDIC-off`
    AFNI_PROC_OUT_SCRIPT=`echo ${AFNI_PROC_OUT_DIR}/S04_Afni-Preproc-fMRI_discovery_${SBJ}-${SES}_NORDIC-off.sh`
    AFNI_PROC_OUT_LOGFILE=`echo ${AFNI_PROC_OUT_DIR}/output.S04_Afni-Preproc-fMRI_discovery_${SBJ}-${SES}_NORDIC-off.txt`
