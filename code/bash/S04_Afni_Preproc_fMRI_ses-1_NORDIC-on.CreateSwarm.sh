...
do
    ...
    #already_done=`grep ${SWARM_PATH} ${AFNI_PROC_OUT_DIR}/S04_Afni_Preproc_fMRI_NORDIC.${SBJ}_${SES}.sh | wc -l`
		#if [ ${already_done} == "1" ]; then
    #   echo "${AFNI_PROC_OUT_DIR}/S04_Afni_Preproc_fMRI_NORDIC.${SBJ}_${SES}.sh already exits --> skipping."
    #else
