...
DOWNLOAD_DIR=`echo ${PRJDIR}/openeuro/meica_eval/`
SUBJECTS_DIR=`echo ${PRJDIR}/freesurfer/`
SCRIPTS_DIR=`echo ${PRJDIR}/me_staticfc/code/bash`
AFNI_PROC_OUT_DIR=`echo ${SCRIPTS_DIR}/S05_Afni-Preproc-fMRI_discovery-${SES}_NORDIC-on`
USERNAME=`whoami`
SWARM_PATH=`echo ${PRJDIR}/swarm.${USERNAME}/S05_Afni-Preproc-fMRI_discovery-${SES}_NORDIC-on.SWARM.sh`
LOGS_DIR=`echo ${PRJDIR}/logs.${USERNAME}/S05_Afni-Preproc-fMRI_discovery-${SES}_NORDIC-on.logs`
