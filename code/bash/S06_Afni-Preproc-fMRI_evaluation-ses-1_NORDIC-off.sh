...
AFNI_PROC_OUT_DIR=`echo ${SCRIPTS_DIR}/S06_Afni-Preproc-fMRI_evaluation-${SES}_NORDIC-off`
USERNAME=`whoami`
SWARM_PATH=`echo ${PRJDIR}/swarm.${USERNAME}/S06_Afni-Preproc-fMRI_evaluation-${SES}_NORDIC-off.SWARM.sh`
LOGS_DIR=`echo ${PRJDIR}/logs.${USERNAME}/S06_Afni-Preproc-fMRI_evaluation-${SES}_NORDIC-off.logs`
...
do
    ...
    AFNI_PROC_OUT_SCRIPT=`echo ${AFNI_PROC_OUT_DIR}/S06_Afni-Preproc-fMRI_evaluation_${SBJ}-${SES}_NORDIC-off.sh`
    AFNI_PROC_OUT_LOGFILE=`echo ${AFNI_PROC_OUT_DIR}/output.S06_Afni-Preproc-fMRI_evaluation_${SBJ}-${SES}_NORDIC-off.txt`
