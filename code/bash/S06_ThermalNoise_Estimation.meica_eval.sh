# 06/06/2025 JGC: Attempt at stimating thermal noise even though we do not have noise scans
...
3dcalc -overwrite -a ${POST_NORDIC_DIR}/rm.constant_gated.post_nordic.thermal_noise_mask.nii.gz \
                  -b ${POST_NORDIC_DIR}/rm.cardiac_gated.post_nordic.thermal_noise_mask.nii.gz  \
                  -expr 'a*b' \
