...
USERNAME=`whoami`
SWARM_PATH=`echo /data/SFIMJGC_HCP7T/BCBL2024/swarm.${USERNAME}/S06_ThermalNoise_Estimation.spreng.SWARM.sh`
LOGS_DIR=`echo /data/SFIMJGC_HCP7T/BCBL2024/logs.${USERNAME}/S06_ThermalNoise_Estimation.spreng.logs`
...
do
   ...
   echo "export SBJ=${sbj}; sh ${SCRIPTS_DIR}/S06_ThermalNoise_Estimation.spreng.sh" >> ${SWARM_PATH}
done
