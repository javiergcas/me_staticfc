...
# Export BrainNetViewer node table with ROI coordinates and network-driven node colors.
...
# Convert hex network colors to normalized RGB rows for BrainNetViewer color input.
c = []
for n in nw_list:
