...
def process_command_line():
    ...
    parser.add_argument("-t", "--line_pref_tolerance", required=False, dest="line_pref_tolerance", default=1e-3, type=float,
                        help="Tolerance for considering points as ties when computing line preference")
    parser.add_argument("-mrq", "--max_radius_quantile", required=False, dest="max_radius_quantile", default=0.95, type=float,
